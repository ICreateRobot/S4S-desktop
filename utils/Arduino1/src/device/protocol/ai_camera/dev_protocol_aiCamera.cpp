 ...
 * @LastEditTime : 2026-05-08 11:52:36
 * @Description  : k210 设备
...
static fmap_result_t fMap_detected(udc_pack_t *pack);
...
static const enum_map_t enum_map = {
    ...
    {"REGION_UP",       (int)hw_ai_camera.REGION_UP},
    {"REGION_MIDDLE",   (int)hw_ai_camera.REGION_MIDDLE},
    {"REGION_DOWN",     (int)hw_ai_camera.REGION_DOWN},

    {"GO_FORWARD",      (int)hw_ai_camera.GO_FORWARD},
    {"GO_BACK",         (int)hw_ai_camera.GO_BACK},
    ...
    {"OBJRCT_AIRPLANE",     (int)hw_ai_camera.OBJRCT_AIRPLANE},
...
static fmap_result_t fMap_detected(udc_pack_t *pack)
{
    ...
    ret = hw_ai_camera.detected(object_class_int, id);
